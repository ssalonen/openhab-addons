...
public class ReadIntoPercentChannelHandlerTest {
    ...
    public static Collection<Object[]> provideArgsForPostProcessTest() {
        ...
        //@formatter:off
                                ...
                                // 33.333.. % non-ending decimal -- get's rounded
                                new Object[] { new PercentType("33.3333333333333333333333333333333300"), new DecimalType("1"), BigDecimal.valueOf(0), BigDecimal.valueOf(3) },
