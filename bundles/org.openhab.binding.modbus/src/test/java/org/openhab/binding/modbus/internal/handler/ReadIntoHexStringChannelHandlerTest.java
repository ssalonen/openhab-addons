...
public class ReadIntoHexStringChannelHandlerTest {
    ...
    public static Collection<Object[]> provideArgsForPostProcessTest() {
        ...
        //@formatter:off
                                ...
                                new Object[] { OnOffType.ON, UnDefType.UNDEF, BigDecimal.valueOf(255), false},
                                new Object[] { OnOffType.OFF, UnDefType.UNDEF, BigDecimal.valueOf(255), true}

                        //@formatter:on
        ).collect(Collectors.toList()));
    }

    // TODO from bits to hexstring
    // TODO from registers to hexstring
}
