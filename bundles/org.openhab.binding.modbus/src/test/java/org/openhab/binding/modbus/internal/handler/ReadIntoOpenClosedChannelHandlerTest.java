 ...
 */
@NonNullByDefault
public class ReadIntoOpenClosedChannelHandlerTest {

    public static Collection<Object[]> provideArgsForPostProcessTest() {
        return Collections.unmodifiableList(Stream.of(
        //@formatter:off
                                new Object[] { OpenClosedType.CLOSED, DecimalType.ZERO, BigDecimal.valueOf(0), false},
                                new Object[] { OpenClosedType.OPEN, DecimalType.ZERO, BigDecimal.valueOf(0), true},
                                new Object[] { OpenClosedType.OPEN, DecimalType.valueOf("3.14"), BigDecimal.valueOf(0), false},
                                new Object[] { OpenClosedType.CLOSED, DecimalType.valueOf("3.14"), BigDecimal.valueOf(0), true},
                                new Object[] { OpenClosedType.CLOSED, DecimalType.valueOf("3.14"), new BigDecimal("3.14"), false},
                                new Object[] { OpenClosedType.OPEN, DecimalType.valueOf("3.14"),  new BigDecimal("3.14"), true},
                                new Object[] { OpenClosedType.CLOSED, DecimalType.valueOf("-3.14"), new BigDecimal("-3.14"), false},
                                new Object[] { OpenClosedType.OPEN, DecimalType.valueOf("-3.14"),  new BigDecimal("-3.14"), true},
    ...
    public void testReadIntoOpenClosedPostProcessWithDecodedNumber(State expectedState, State decodedNumberState,
            BigDecimal closedValue, boolean inverted) {
